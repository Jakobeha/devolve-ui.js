...
pub struct Renderer {
    ...
    cached_renders: RefCell<HashMap<NodeId, CachedRender>>,
...
impl Renderer {
    ...
    /// ```
    /// use devolve_ui::renderer::Renderer;
    /// use devolve_ui::rsx;
    /// use std::time::Duration;
    ///
    ...
    pub fn root(self: Rc<Renderer>, construct: impl FnOnce() -> Box<VComponent>) {
    ...
    fn set_root_component(self: Rc<Renderer>, root_component: Option<Box<VComponent>>) {
    ...
    #[cfg(feature = "time")]
    pub fn resume(self: Rc<Renderer>) {
    ...
    #[cfg(feature = "time")]
    pub fn is_running(self: Rc<Renderer>) -> bool {
        self.running_task.borrow().is_some()
    }

    #[cfg(feature = "time")]
    pub fn set_interval(self: Rc<Renderer>, interval_between_frames: Duration) {
    ...
    pub(crate) fn invalidate(self: Rc<Renderer>, view: &Box<VView>) {
