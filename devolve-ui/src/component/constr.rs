...
use std::fmt::Debug;
use crate::component::component::{VComponent};
use crate::component::context::{VComponentContext, VComponentContext2};
...
/// Usage:
/// ```rust
/// use devolve_ui::component::constr::make_component_macro;
...
///
/// fn basic<TParam: Any, ViewData: HasTuiViewData>((c, Basic { optional_field, another_optional, required_field }): VComponentContext2<Basic<TParam>, ViewData>) -> VNode<ViewData> {
///     vbox(d(), d(), vec![
...
mod tests {
    ...
    use crate::component::constr::{_make_component_macro, make_component, make_component_macro};
    use crate::component::node::VNode;
