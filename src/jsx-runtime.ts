 ...
 */
import { PlatformNode } from 'index'
import { JSX as SolidJSX } from 'solid-js/types/jsx'

type DOMElement = SolidJSX.Element;

export namespace JSX {
  type Element =
    | PlatformNode
  // The rest is copied directly from solid-js/jsx-runtime
    | ArrayElement
    | FunctionElement
    | (string & {})
    | number
